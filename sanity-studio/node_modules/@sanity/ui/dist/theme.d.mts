 ...
 */
export declare interface ThemeColor extends Partial<
  Omit<ThemeColorGenericState, "muted">
> {
  base: ThemeColorBase;
...
/** @public */
export declare interface ThemeColorButtonTokens extends Partial<
...
/** @public */
export declare interface ThemeColorInputTokens extends Partial<
...
export declare type ThemeColorName =
  "transparent" | "default" | "primary" | "positive" | "caution" | "critical";
...
export declare type TokenValueNode =
  TokenColorValueNode | TokenHueValueNode | TokenBlendModeValueNode;
