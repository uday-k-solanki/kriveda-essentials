...
export default function SpecularButton({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      (lineC as any).set(p.lineColor);
      (baseC as any).set(p.baseColor);
      program.uniforms.uAngle.value = angle;
      program.uniforms.uRadius.value = Math.min(p.radius, Math.min(sizeRef.w, sizeRef.h) / 2) * dpr;
      program.uniforms.uLineColor.value = [(lineC as any).r, (lineC as any).g, (lineC as any).b];
      program.uniforms.uBaseColor.value = [(baseC as any).r, (baseC as any).g, (baseC as any).b];
